...
def main():
    ...
    logger.info(f"caption weight: {config.caption_weight}, text patch num: {config.text_patch}")
    logger.info(f"noclip_lr: {config.noclip_lr}")
    logger.info(f"loss: {config.loss}")
    logger.info(f"device: {config.device}")
    logger.info(f"num multi head: {config.num_mha_heads}")
    logger.info(f"is frozen clip: {config.frozen_clip}")
